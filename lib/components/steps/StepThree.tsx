                        ...
                        <Box sx={styles.wrap}>
                            ...
                            <Box sx={styles.row}>
                                ...
                                <Box width='100%' mt={1.5}>
                                    <Box onClick={() => setTogglePairingSuggestions(!togglePairingSuggestions)}
                                         mb={togglePairingSuggestions ? 3 : 0} display='inline-flex' alignItems='center'
                                         gap={1} sx={{cursor: 'pointer', userSelect: 'none'}}>
                                        <PairIcon/>
                                        <Typography sx={{
                                            fontSize: '0.75rem',
                                            color: '#4F5359',
                                            ...
                                            title={
                                                <>
                                                    ...
                                                    <Typography sx={{
                                                        ...
                                                        scenarious, tooltips help the user understand meaning, function
                                                        or alt-text.
                                                    </Typography>
                                                </>
                                            }
