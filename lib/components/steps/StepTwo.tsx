import { Box, Button, Checkbox, Chip, Divider, Grid, IconButton, Tab, Tabs, Tooltip, Typography } from '@mui/material';
import { ModalLayout } from "../layout/ModalLayout.tsx";
import { useCdeContext } from "../../CdeContext.tsx";
import React from 'react';
import { ArrowIcon, CheckboxDefault, CheckboxSelected, ChevronRight, GlobeIcon } from '../../icons/index.tsx';
        ...
        <ModalLayout>
            ...
            <Box p='1.5rem' pb={0}>
                ...
                <Box mb={3}>
                    ...
                    <Box maxHeight='9.375rem' overflow='auto' display='flex' flexDirection='column' gap='1.5rem'>
                ...
                <Box position='sticky' bottom={0} justifyContent='space-between' display='flex' alignItems='center' sx={{ background: '#fff', zIndex: 9 }} py='1rem' borderTop='0.0625rem solid #ECEDEE'>
