...
import {areMappingsValid, getMappingsDict} from '../../services/mappingService.ts';
...
function Home() {
    ...
    const handleStartMapping = async () => {
        ...
        try {
            if (areMappingsValid(mappings)) {
                const mappingsDict = getMappingsDict(mappings)
                setCDEMapping(mappingsDict);
